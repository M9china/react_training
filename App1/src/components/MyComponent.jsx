  ...
  return (
    <>
      ...
      <p className="aboutMe">In my latest blog post, I talk about my journey as a computer systems engineer and full-stack developer, and how I discovered my passion for backend development.
       ...
       I'm excited to continue my journey in this field, learning new technologies and approaches to software development while building robust systems</p>
    </div>
    </>
